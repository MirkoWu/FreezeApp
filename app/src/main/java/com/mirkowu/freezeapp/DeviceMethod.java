...
public class DeviceMethod {
    ...
    public void hideApp(String pgkName) {
        hideApp(pgkName, true);
    }

    public void unHideApp(String pgkName) {
        hideApp(pgkName, false);
    }

    public void hideApp(String pgkName, boolean isHide) {
        if (devicePolicyManager.isAdminActive(componentName)) {
            devicePolicyManager.setApplicationHidden(componentName, pgkName, isHide);
        } else {
